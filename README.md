...
> - **专属优惠码**：结算时输入 `eoht` 可享 8 折，适用套餐与最终实付金额以结算页为准。
...
**本页汇总九云机场(9Yun)套餐价格、专属 8 折优惠码 `eoht`、海外中转线路、流媒体与 AI 支持及测速记录；价格和节点状态可能调整，购买前请以服务商结算页信息为准。**
...
> **专属优惠码、周期与流量说明**
>
> - **专属 8 折优惠码**：`eoht`。结算时输入并确认折扣生效；下表保留套餐标价，未预先叠加优惠，适用套餐与最终实付金额以结算页为准。
